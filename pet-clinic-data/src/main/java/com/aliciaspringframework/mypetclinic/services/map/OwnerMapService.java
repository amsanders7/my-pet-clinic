...
@Service
@Profile({"default", "map"})  //if we don't specify an active profile, the active profile will be default & we only want this class to be implemented if the default profile is active or if the map profile is active.
